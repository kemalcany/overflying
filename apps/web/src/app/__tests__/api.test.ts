...
describe('API Client', () => {
  ...
  describe('getJobs', () => {
    it('fetches jobs from the API', async () => {
      const mockJobs = [
        { id: '1', name: 'Job 1', priority: 1, state: 'queued', created_at: '2025-01-01' },
        { id: '2', name: 'Job 2', priority: 2, state: 'running', created_at: '2025-01-02' },
      ]
  ...
  describe('getJob', () => {
    it('fetches a single job by ID', async () => {
      const mockJob = { id: '123', name: 'Test Job', priority: 5, state: 'queued', created_at: '2025-01-01' }
  ...
  describe('createJob', () => {
    it('creates a new job', async () => {
      ...
      const mockResponse = { id: '456', ...jobData, state: 'queued', created_at: '2025-01-01' }
  ...
  describe('updateJob', () => {
    it('updates an existing job', async () => {
      ...
      const mockResponse = { id: jobId, ...updateData, state: 'queued', created_at: '2025-01-01' }
    ...
    it('throws error when update fails', async () => {
      ...
      await expect(api.updateJob('999', { name: 'Updated' })).rejects.toThrow('Failed to update job: Not Found')
    })
  })
  ...
  describe('deleteJob', () => {
    ...
    it('throws error when delete fails', async () => {
      ...
      await expect(api.deleteJob('999')).rejects.toThrow('Failed to delete job: Not Found')
    })
  ...
  describe('error handling', () => {
    ...
    it('handles network errors in createJob', async () => {
      ...
      await expect(api.createJob({ name: 'Test', priority: 1, params: {} })).rejects.toThrow('Network error')
    })
  })

  describe('partial updates', () => {
    it('allows updating only name', async () => {
      const mockResponse = { id: '1', name: 'New Name', priority: 5, state: 'queued', created_at: '2025-01-01' }
    ...
    it('allows updating only priority', async () => {
      const mockResponse = { id: '1', name: 'Test', priority: 100, state: 'queued', created_at: '2025-01-01' }
