...
describe('JobForm', () => {
  ...
  it('displays default values when provided', () => {
    render(<JobForm onSubmit={mockOnSubmit} onCancel={mockOnCancel} defaultValues={{ name: 'Test Job', priority: 10 }} />)
  ...
  it('disables buttons when isSubmitting is true', () => {
    render(<JobForm onSubmit={mockOnSubmit} onCancel={mockOnCancel} isSubmitting />)
